...
% REPLACE WITH
The squared inputs reject whiteness in 100% of the clustered calibrations (p < 10^{-10}) and already over-reject on the i.i.d. arm (5.8% at nu=7), where Student's t innovations with nu <= 6 deprive eps_t^2 of a fourth moment and the chi^2 approximation fails
% END OF BLOCK
~~~~~~~~~
...
% REPLACE WITH
already over-reject on the i.i.d. arm (5.8% at nu=7, 7.9% at nu=6, 8.8% at nu=5)
% END OF BLOCK
~~~~~~~~~
