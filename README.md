...
* `docs/`: Contains the deviation register (`DEVIATIONS.md`), per-experiment markdown reports (`sections/`), and the frozen LaTeX corrections parked for the final version (`camera_ready_candidates/`).
