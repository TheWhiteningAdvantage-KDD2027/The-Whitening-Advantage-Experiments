...
*Note on execution order:* `run_all.sh` executes the streams in a strict topological order to resolve cross-stream data dependencies (e.g., R08 consumes the exact lattice law generated by R10, and R13 consumes the regime census generated by R16). The execution sequence therefore differs from the alphanumeric order of the manuscript sections.
